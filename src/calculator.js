  ...
  return (
    <div className="calculator">
      ...
      <div className="buttons">
        ...
        <button className="button" onClick={() => handleClick('%')}>%</button>
        <button className="button operation yellow" onClick={() => handleClick('÷')}>/</button>
        ...
        <button className="button operation yellow" onClick={() => handleClick('x')}>x</button>
        ...
        <button className="button operation yellow" onClick={() => handleClick('+')}>+</button>
        <button className="button zero two-column" onClick={() => handleClick('0')}>0</button>
        <button className="button" onClick={() => handleClick('.')}>.</button>
        <button className="button operation yellow" onClick={() => handleClick('=')}>=</button>
      </div>
    </div>
